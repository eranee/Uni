...
RK <- c(9,13:20)
SPZeta <- SPZeta[-RK,1:981]
Zdm <- Zeta.decline.mc(SPZeta,orders=1:nrow(SPZeta),sam=1000)
Zom <- Zeta.order.mc(SPZeta,order=2,sam=1000)
par(mfrow=c(1,1))
...
ggsave(file="ZetaDecline.png",dpi=1000)
